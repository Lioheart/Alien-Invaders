"""Umożliwia wyświetlanie podstawowych statystyk na ekranie gry."""
import pygame.font
...
class Scoreboard:
    ...
    def prep_score(self):
        ...
        rounded_score = round(self.stats.score, -1)  # Zaokrągla do najbliższej wielokrotności
    ...
    def prep_ship(self):
        ...
        for ship_number in range(self.stats.ships_left):
            ...
            ship.image = pygame.transform.scale(ship.image, (25, 30))
